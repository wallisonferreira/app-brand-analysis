...
class ChatConsultantBkp
{
    ...
    public function send(string $message): ?string
    {
        ...
        $response = Http::withHeaders([
        ...
        ])->post($this->ENDPOINT_URL . "openai/deployments/" . $this->DEPLOYMENT_NAME . "/chat/completions?api-version=2024-02-15-preview", [
            'messages' => $this->messages,
            "model" => "gpt-4o-mini",
            "max_tokens" => 16000,
            "temperature" => 0.7,
            ...
            "data_sources" => [
                [
                    ...
                    "parameters"=> [
                        "filter"=> null,
                        "endpoint"=> "https://puddy-ai-search.search.windows.net/",
                        "index_name"=> "pppi-consultancy-index",
                        "semantic_configuration"=> "azureml-default",
                        "authentication"=> [
                            "type"=> "api_key",
                            "key"=> "HekaCPbK5A1tsd15pkReGZHCNwDhresQJrlowVZGLFAzSeBgU4fJ"
                        ],
                        "embedding_dependency" => [
                            "type" => "endpoint",
                            "endpoint" => "https://ai-pppihub397681054968.openai.azure.com/openai/deployments/text-embedding-ada-002/embeddings?api-version=2023-07-01-preview",
                            "authentication" => [
                                "type" => "api_key",
        ...
        $collect_response = collect([
            ...
            "intent" => $response->choices[0]->context->intent
        ]);
